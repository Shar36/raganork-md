...
module.exports = {
    ...
    BOT_INFO: process.env.BOT_INFO || 'Raganork;𝓗𝓘𝓩𝓑𝓤𝓛𝓛𝓐𝓗;0;https://i.imgur.com/P7ziVhr.jpeg;https://chat.whatsapp.com/Dt3C4wrQmt0GG6io1IBIHb',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '',
    NOT_ALLOWED: process.env.ALLOWED || '',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || ',!',
    STICKER_DATA: process.env.STICKER_DATA || "ᴍᴀᴅᴇ ʙʏ|ᴀʟᴀɴ ᴡᴀʟᴋᴇʀ",
